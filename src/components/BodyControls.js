            ...
            { user?.uid ? 
                <div>
                    <div className="row m-3">
                        <h2 className="p-2 text-center">Hello, {user.displayName}!</h2>
                    </div>
                    <div className="m-3">
                        <div className="btn-group justify-content-center d-flex mb-4" role="group" aria-label="filterButtons">
                                ...
                                <div className="modal-body">
                                    <form onSubmit={submitForm}>
                                        <div className="mb-3">
                                            ...
                                            <input className="form-control" name="id" maxLength="8" required></input>
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">Item name(s)</label>
                                            <input className="form-control" name="title" maxLength="20" required></input>
                                        </div>
                                        <div className="mb-3">
                ...
                <h2 className="p-2 mx-auto">Please log in to start organizing</h2>
            }
        </div>
    );
}
